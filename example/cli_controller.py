...
# To learn more about the controller and what it requires read the READ.ME.
#
# The methods starting with do_ and help_ are used by cmd.Cmd to generate the  cli-commands.
# MIGHT NOT TO PARSE THE MESSAGE NEED TO EVALAUTE BEFORE PUSHING
# SHOULD RENAME Message import to MessageUtil
class SimulinkMessage(cmd.Cmd):
    ...
    def do_send(self, args):
        ...
        if message['finger'] is None or message['curl'] is None:
            print('Invalid message! Will not be sent.') return 0
        else:
